...
export interface CreateSimArgs<TContent extends SimContentLike = SimContent, TConfig extends SimConfigLike = SimConfigLike> {
...
export type SimFactory<TSim extends TestableSimLike, TContent extends SimContentLike = SimContent, TConfig extends SimConfigLike = SimConfigLike> = (args: CreateSimArgs<TContent, TConfig>) => TSim;
