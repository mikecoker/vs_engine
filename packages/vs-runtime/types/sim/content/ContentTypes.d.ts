...
export type StatModifierKey = "maxHp" | "moveSpeed" | "pickupRadius" | "might" | "cooldownMultiplier" | "durationMultiplier" | "areaMultiplier" | "projectileCount" | "armor" | "luck";
...
export interface PlayerCharacterDef extends BaseContentDef<PlayerCharacterId> {
...
export interface EnemyArchetypeDef extends BaseContentDef<EnemyArchetypeId> {
    readonly spriteKey: string;
...
export interface PassiveUpgradeDef extends BaseContentDef<PassiveUpgradeId> {
    readonly description: string;
    readonly iconKey: string;
    readonly maxLevel: number;
