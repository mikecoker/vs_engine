import type { SimContent } from "../../sim/core/SimApi";
import type { RenderSnapshot } from "../../sim/core/RenderSnapshot";
import { createClientContentCatalog } from "../content/ClientContentCatalog";
import { EnemyRenderPool, type EnemyViewModel } from "./EnemyRenderPool";
import { PickupRenderPool, type PickupViewModel } from "./PickupRenderPool";
import { presentPlayer, type PlayerViewModel } from "./PlayerPresenter";
import { ProjectileRenderPool, type ProjectileViewModel } from "./ProjectileRenderPool";
